...
\usepackage{xcolor}
	\definecolor{HITblue}{RGB}{38, 113, 142}
        \definecolor{SDUred}{RGB}{156, 12, 19}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.6\textwidth]{SDU_background.png}};
    \end{tikzpicture}
\vfill}}}
...
\def\Where{\hspace{-1.2mm}\textbf{\color{SDUred}
School of Computer Science and Technology, \\ Shandong University
}} 
%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
%
% Set your preferred primary contact address here.
\def\Address{72 Binhai Highway, Jimo,} 
%
\def\CityZip{Qingdao, Shandong, 266237} 
%
% Set your HIT e-mail here
\def\Email{\textbf{\color{SDUred}E-mail}: cs@sdu.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{SDUred}Phone}: 86-532-58630620}
%
% Set your department or personal website here
\def\URL{\textbf{\color{SDUred}URL}: https://www.cs.sdu.edu.cn}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
\def\school{\small{
  SDU $\cdot$
     ~School of Computer Science and Technology, $\cdot$
     ~72 Binhai Highway$\cdot$
     ~Qingdao, China} } 
