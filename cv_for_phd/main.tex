...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{header}
    \fontsize{25 pt}{25 pt}\selectfont Zhixiong Xiao
    ...
    \AND%
    \kern 5.0 pt%
    \mbox{\hrefWithoutArrow{mailto:xiaozxiong@mail.sdu.edu.cn}{xiaozxiong@mail.sdu.edu.cn}}%
    \kern 5.0 pt%
    \AND%
    \kern 5.0 pt%
    \mbox{\hrefWithoutArrow{tel:+86 xxxxxxxxx}{+86 xxxxxxxxx}}%
    % \kern 5.0 pt%
    % \AND%
    % \kern 5.0 pt%
